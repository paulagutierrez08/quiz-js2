...
console.log("[Question #23]: ", (temperature *= 2)); // should print 70

// 24. Divide 'temperature' by 5 using the /= operator.

console.log("[Question #24]: ", (temperature /= 5)); // should print 14
...
const insensitiveManner = stringVar === "hello";
console.log("[Question #33]: ", stringVar); // should print true

// 34. Check if 'booleanVar' is truthy.

const truthy = Boolean(booleanVar);
console.log("[Question #34]: ", truthy); // should print falsey

// 35. Log the opposite value of 'booleanVar' to the console using the NOT operator.

const opposite = !booleanVar;
console.log("[Question #35]: ", opposite); // should print opposite

// 36. Check if 'fruits' array contains more than 3 elements.

const elements = fruits.length > 3;
console.log("[Question #36]: ", elements); // should print true if it does, false if it does not
...
car.make = "Toyota";
console.log("[Question #38]: ", car.make); // should print object with make key = Toyota
...
const variableOrExpression = numberVar < 10 && temperature > 20;
console.log("[Question #41]: ", variableOrExpression); // should print false
...
const include = fruits.includes("banana");
console.log("[Question #43]: ", include); // should print true

// 44. Check if the value of 'numberVar' is between 4 and 6.

const between = numberVar > 4 && numberVar < 6;
console.log("[Question #44]: ", between); // should print true
...
const startLetter = stringVar.startsWith("H");
console.log("[Question #46]: ", startLetter); // should print true
...
const endLetter = stringVar.endsWith("o");
console.log("[Question #48]: ", endLetter); // should print true
...
if (temperature > 25) {
  console.log("[Question #13] Too hot!");
} else {
  console.log("[Question #13] Just right!");
}
...
console.log("[Question #56]: ", book); // should print 1949
...
console.log("[Question #68]:", isVisible !== false);
...
typeof city == "string";
console.log("[Question #72]: ", true); // should print true

// 73. Declare an array named 'days' and add 'Monday' and 'Tuesday' to it.

const days = ["Monday", "Tuesday"];
console.log("[Question #73]: ", days); // should print true
...
// circleArea += 25;
// console.log("[Question #78]: ", circleArea); // should print true
...
console.log("[Question #92]: ", bookTitle.startsWith("The"));
